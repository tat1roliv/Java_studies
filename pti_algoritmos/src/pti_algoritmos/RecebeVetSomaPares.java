...
public class RecebeVetSomaPares {
	...
	public static void main(String[] args) {
		...
		int resultado = somaPares(v);
		System.out.print("Soma dos valores pares informados: "+ resultado);//calcula se par e exibe return da funcao	
	}
